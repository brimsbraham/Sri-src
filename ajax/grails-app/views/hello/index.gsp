...
<script type="text/javascript">
    $(document).ready(function () {
        $('#PersonTableContainer').jtable({
            ...
            actions: {
                listAction: '${createLink(controller:'home',action:'list')}',
                createAction:'${createLink(controller:'home',action:'create')}',
                updateAction: '${createLink(controller:'home',action:'update')}',
                deleteAction: '${createLink(controller:'home',action:'delete')}'
            },
            fields: {
                airportid: {
